            ...
            <div className="space-y-5">
              ...
              <Tabs value={sourceType} onValueChange={setSourceType}>
                ...
                <TabsContent value="upload" className="space-y-4 mt-4">
                  ...
                  >
                    ...
                    {formData.source_url && sourceType === 'upload' && (
                      <motion.p 
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="text-sm text-emerald-400 mt-3 flex items-center justify-center gap-2"
                      >
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  disabled={!formData.title || !formData.source_url || isProcessing || !transLimit.allowed}
